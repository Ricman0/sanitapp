...
//                . $url . "<br>"
        ...
        $to = $dati['email'];
        $subject =  "Conferma Account SanitApp";
        $headers = "From : SanitApp <" . $this->_email->From . "> \r\n";
        $headers .= "Content-Type: text/html; charset=UTF-8\r\n";

        $inviata = mail($to, $subject, $testo, $headers);
...
//        $inviata = $this->_email->send();
        ...
        $to = $datiPerMail['emailDestinatario'];
...
//        $this->_email->Subject = 'Memo Prenotazione ';// = $subject;
        ...
        $to = $infoPrenotazione['email'];
        $subject =  'Memo Prenotazione ';
...
//        $inviata = $this->_email->send();
        ...
        $to = $infoPrenotazione['email'];
        $subject = 'Riepilogo prenotazione ' .$infoPrenotazione['nomeEsame']. ' del ' . $infoPrenotazione['data'];
...
//        $this->_email->Subject = 'Notifica referto ';// = $subject;
        ...
        $to = $datiNotifica['email'];
        $subject = 'Notifica referto ';
        $headers = "From : SanitApp <" . $this->_email->From . "> \r\n";
        $headers .= "Content-Type: text/html; charset=UTF-8\r\n";
...
//        $this->_email->Subject = "Recupero Password Account SanitApp";
        ...
        $to = $dati['email'];
        $subject = "Recupero Password Account SanitApp";
        $headers = "From : SanitApp <" . $this->_email->From . "> \r\n";
        $headers .= "Content-Type: text/html; charset=UTF-8\r\n";
