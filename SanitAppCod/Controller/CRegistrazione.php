...
//                return $vRegistrazione->restituisciFormMedico();
    ...
    private function recuperaDatiECreaClinica() {
        ...
        if ($validi) {
            ...
            $eClinica = new EClinica($datiClinica['username'], $datiClinica['partitaIVA'], $datiClinica['nomeClinica'], $datiClinica['titolare'], $datiClinica['via'], $datiClinica['numeroCivico'], $datiClinica['cap'], $datiClinica['localitàClinica'], $datiClinica['provinciaClinica'], $regione, $datiClinica['email'], $datiClinica['PEC'], $datiClinica['password'], $datiClinica['telefono'], $datiClinica['capitaleSociale'], $datiClinica['orarioAperturaAM'], $datiClinica['orarioChiusuraAM'], $datiClinica['orarioAperturaPM'], $datiClinica['orarioChiusuraPM'], $datiClinica['orarioContinuato'], $codiceConferma);
