...
class UCronTab {
    ...
    private $path; //path del file  represent a 'default directory' for our temporary cron files.
    private $handle; //nome del file cron temporaneo
    private $cron_file; // full path più il nome del file cron temporaneo
 
    /**
     * @access public
     * @param type $host Indirizzo IP del server al quale connettersi
     * @param type $port Numero di porta usata dalla connessione ssh2
     * @param type $username User log in name per il server
