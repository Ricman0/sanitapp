<form name="inserisciMedico" method="post" id="inserisciMedico">
    ...
    <input type="text" name="codiceFiscale" class="elementiForm" id="codiceFiscaleMedico" maxlenght="16" placeholder="MRARSS67S42G438S" value="{if isset($datiValidi.codiceFiscale)}{$datiValidi.codiceFiscale}{/if}" required/>
    ...
    <input type="text" name="CAPMedico" class="elementiForm" id="CAPMedico" maxlenght="5" placeholder="65017" value="{if isset($datiValidi.CAP)}{$datiValidi.CAP}{/if}" required/>
