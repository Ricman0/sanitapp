<div id="divContatti" class="affiancato">
    <i class="fa fa-user fa-5x faAzzurro centrato block" id="iconaContatti" aria-hidden="true"></i>
    <h3>Contatti</h3>
    <div id="contattiTelefonici" class="affiancato verticalmenteAllineato margine40" >
        <i class="fa fa-phone fa-4x faAzzurro affiancato margine20 verticalmenteAllineato" id="iconaContattiTelefonici" aria-hidden="true"></i>
    ...
    <div id="contattiMail" class="affiancato verticalmenteAllineato margine40">
        <i class="fa fa-envelope fa-4x faAzzurro affiancato margine20 verticalmenteAllineato" id="iconaContattiMail" aria-hidden="true"></i>
