<form name="inserisciUtente" method="post" id="inserisciUtente"> 
    ...
    <input type="text" name="codiceFiscale" id="codiceFiscaleUtente" maxlenght="16" class="elementiForm" placeholder="MRARSS67S42G438S" value="{if isset($datiValidi.codiceFiscale)}{$datiValidi.codiceFiscale}{/if}" required />
    <br>
    ...
    <input type="text" name="CAP" id="CAP" maxlenght="5" class="elementiForm" placeholder="65017" value="{if isset($datiValidi.CAP)}{$datiValidi.CAP}{/if}" required />
    <br>
