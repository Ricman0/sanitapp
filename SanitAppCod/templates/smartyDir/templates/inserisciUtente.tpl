<form name="inserisciUtente" method="post" id="inserisciUtente"> 
    ...
    <input type="text" name="nome" id="nomeUtente" class="elementiForm" placeholder="Mario"  required/>
    <br>
    
    <label for="cognome" class="elementiForm">Cognome</label>
    <input type="text" name="cognome" id="cognomeUtente" class="elementiForm" placeholder="Rossi" required/>
    <br>
    
    <label for="codiceFiscale" class="elementiForm">Codice Fiscale</label>
    <input type="text" name="codiceFiscale" id="codiceFiscaleUtente" class="elementiForm" placeholder="MRARSS67S42G438S" required/>
    <br>
    

    <label for="indirizzo" class="elementiForm">Indirizzo</label>    
    <input type="text" name="indirizzo" id="indirizzoUtente" class="elementiForm" placeholder="Via/C.da Acquaventina" required/>
    <br>
    ...
    <div class="username">    
        ...
        <input type="text" name="username" id="usernameUtente" class="elementiForm" placeholder="Mario" required />
        <br>
